...
def run_training_loop(
    ...
    for epoch, ((training_X_batch, training_y_batch), (val_X_batch, val_y_batch)) in enumerate(zip(train_loader, val_loader)):
        ...
        epoch_accuracy = (logits_to_prediction(training_predictions, positive_threshold) == training_y_batch).float().mean()
        epoch_val_accuracy = (logits_to_prediction(validation_predictions, positive_threshold) == val_y_batch).float().mean()
